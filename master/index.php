<?php
session_start();
if (isset($_COOKIE['beconnect_master'])) {
    $obj = json_decode($_COOKIE['beconnect_master']);
    //setcookie('beconnect_master', "", time() + (86400 * 30), "/");
    setcookie("beconnect_master", "", time() - 3600);
          ...
          $.ajax({
              ...
              if(loginObj.CODE_MESSAGE =="SUCCESS"){
               var data = {'data':response};
            	   $.redirect("main.php",data,"POST",null,null,true);
