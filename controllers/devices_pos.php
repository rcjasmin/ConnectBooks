...
$where = "WHERE ( NomBanque LIKE '%$search%' OR AddresseBanque LIKE '%$search%' OR EMEI LIKE '%$search%' ) AND EntrepriseId='$entrepriseId'";
...
$query = "SELECT *  FROM lottery.innov_vw_devices_pos " . $where . " LIMIT $offset,$rows";
$rs = Database::getInstance()->select($query);
$items = array();
