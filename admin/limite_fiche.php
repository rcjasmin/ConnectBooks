...
?>		
	  <div id="Main" align="center">
		...
		<table id="dg" class="easyui-datagrid"
			...
			url=<?php echo $url_combobox_tirages1; ?> title="CONFIGURATION DE LIMITES PAR TICKET" iconCls=""
			toolbar="#tb" rownumbers="true" pagination="true" singleSelect="true">

			<thead>
				<tr>
					<th field="Nom" style="width: 300px;" sortable="true">TIRAGE</th>
					<!-- <th field=JEU style="width: 300px;" sortable="true">TYPE JEU</th>
					<th field=Montant style="width: 300px;" sortable="true">MONTANT</th>
					-->
...
<!-- 
		<div id="tb" style="padding: 5px; height: auto">
			<span class="alignment"
				style="float: right; margin-right: 0px; margin-top: 8px;"> <a
...
-->
	...
	var operation_type= '';
	var id =0;
	var vurl = '../api/CreateLocalDB.php?e=<?php echo $entrepriseId;?>&level=LIMITE_FICHE';
    function openForm() {
    ...
    function Save() {	 
       ...
       if (selectedTirage){
    	...
    	url = '../controllers/limite_fiche_crud.php?u=<?php echo $userId;?>&e=<?php echo $entrepriseId;?>&t='+selectedTirage.Id;
        $('#fm').form('submit', {
            url: url,
            onSubmit: function () {
	...
	<script type="text/javascript">
    	$('#dg').datagrid({
            onDblClickRow:function(index,row){
            	...
            	var url_data = '../controllers/limite_fiche_data.php?e=<?php  echo $entrepriseId;?>&Tirage=' + row.Id;
        ...
        function Configurer(obj){
        	var url_data = '../controllers/limite_fiche_data.php?e=<?php  echo $entrepriseId;?>&Tirage=' + obj.id;
      		 $.get( url_data, function(data) {
          		 var obj1 = JSON.parse(data);
      			 $('#fm').form('load',obj1);
      			$('#dlg').dialog('open').dialog('setTitle', 'Limite Ticket Tirage : '+obj.value);
      			$('#dlg').window('center');
      		 });
        }
    </script>
	...
	$(function () {
        $('#dg').datagrid({
            ...
            onExpandRow: function (index, row) {
                ...
                $('#ddv-' + index).datagrid({
                    url: '../controllers/limite_fiche.php?e=<?php  echo $entrepriseId;?>&Tirage=' + row.Id,
                    fitColumns: true,
                    singleSelect: false,
                    rownumbers: true,
