...
<body>
<?php
    $url = "../controllers/rep_par_superviseur_hist.php?u=" . $userId . "&e=" . $entrepriseId;
...
?>		
	  <div id="Main" align="center">
		<table id="dg" class="easyui-datagrid"
			...
			url=<?php echo $url; ?> title="HISTORIQUE - RAPPORT PAR SUPERVISEUR" iconCls=""
	...
	<script>
        function openNewPrintWindow(){
            var url = 'rep_par_superviseur_print_hist.php?e=<?php echo $entrepriseId;?>&b='+
