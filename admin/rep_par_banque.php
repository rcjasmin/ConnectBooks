...
<body>
<?php
$url = "../controllers/rep_par_banque.php?u=" . $userId . "&e=" . $entrepriseId;
...
?>		
	  <div id="Main" align="center">
		<table id="dg" class="easyui-datagrid"
			...
			url=<?php echo $url; ?> title="RAPPORT PAR BANQUE" iconCls=""
	...
	<script>
        function openNewPrintWindow(){
            var url = 'rep_par_banque_print.php?e=<?php echo $entrepriseId;?>&b='+
