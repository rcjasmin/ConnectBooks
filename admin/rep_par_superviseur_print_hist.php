...
$Superviseurs = (isset($_GET['b'])) ? htmlentities($_GET['b']) : '';
...
$query = "SELECT lottery.webapp_GetReportHeaderInfos('$entrepriseId','$Superviseurs','$Tirages','$DateDebut','$DateFin') AS RESPONSE";
//echo $query;
...
$where = " WHERE a.EntrepriseId='$entrepriseId' AND a.Statut IN ('JOUE','PAYE') AND  b.Role='SUPERVISEUR' AND b.Statut='ACTIF' ";
$q = "";
$t = "";

$Superviseurs = explode(",", $Superviseurs);
...
$query = "SELECT  b.Id AS SuperviseurId,CONCAT(Nom,' ',Prenom) AS SUPERVISEUR,
          GetDeviseEntrepriseById(GetEntrepriseIdByBanqueId_1(GetBanqueIdByUtilisateurId(b.Id))) AS DEVISE,
          ...
          FROM lottery.innov_pari_historique a
	      JOIN lottery.innov_pos_utilisateur b
	      ON a.EntrepriseId= b.EntrepriseId";
$query .= $where;
$query .= " GROUP BY b.Id ";
...
<body>
	<div id=content>
		...
		<div style="text-align: center;">
			...
			<u><h3>RAPPORT PAR SUPERVISEUR</h3></u>
