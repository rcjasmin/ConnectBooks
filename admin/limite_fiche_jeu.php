...
?>		
	  <div id="Main" align="center">
		...
		<table id="dg" class="easyui-datagrid"
			...
			url=<?php echo $url_combobox_tirages1; ?> title="CONFIGURATION DE LIMITES PAR TYPE DE JEU" iconCls=""
    ...
    function Save() {	 
       ...
       if (selectedTirage){
    	...
    	url = '../controllers/limite_jeu_crud.php?u=<?php echo $userId;?>&e=<?php echo $entrepriseId;?>&t='+selectedTirage.Id;
        $('#fm').form('submit', {
            url: url,
            onSubmit: function () {
	...
	<script type="text/javascript">
    	$('#dg').datagrid({
            onDblClickRow:function(index,row){
            	...
            	var url_data = '../controllers/limite_jeu_data.php?e=<?php  echo $entrepriseId;?>&Tirage=' + row.Id;
        ...
        function Configurer(obj){
        	var url_data = '../controllers/limite_jeu_data.php?e=<?php  echo $entrepriseId;?>&Tirage=' + obj.id;
      		 $.get( url_data, function(data) {
	...
	$(function () {
        $('#dg').datagrid({
            ...
            onExpandRow: function (index, row) {
                ...
                $('#ddv-' + index).datagrid({
                    url: '../controllers/limite_jeu.php?e=<?php  echo $entrepriseId;?>&Tirage=' + row.Id,
                    fitColumns: true,
                    singleSelect: false,
                    rownumbers: true,
